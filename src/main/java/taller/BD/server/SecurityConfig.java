...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .authorizeRequests().antMatchers("/pers").hasRole("AUTORIZADO")
                .antMatchers("/pers").hasRole("VISITANTE")
                .antMatchers(HttpMethod.GET, "/movimientoses").hasRole("AUTORIZADO")
                .antMatchers(HttpMethod.GET, "/movimientoses").hasRole("VISITANTE")
                .antMatchers(HttpMethod.POST, "/movimientoses").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/Usuario").hasRole("VISITANTE")
                .antMatchers(HttpMethod.POST, "/Usuario").hasRole("AUTORIZADO")
                .antMatchers(HttpMethod.GET, "/Usuario").hasRole("VISITANTE")
